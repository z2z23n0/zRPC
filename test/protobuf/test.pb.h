...
class GetFriendListsResponse :
 ...
 public:
  ...
  ::test::User* mutable_friendlist(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::test::User >*
      mutable_friendlist();
  private:
  const ::test::User& _internal_friendlist(int index) const;
  ::test::User* _internal_add_friendlist();
  public:
  const ::test::User& friendlist(int index) const;
  ::test::User* add_friendlist();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::test::User > friendlist_;
  ::test::ResultCode* result_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
...
inline ::test::User* GetFriendListsResponse::mutable_friendlist(int index) {
  // @@protoc_insertion_point(field_mutable:test.GetFriendListsResponse.friendList)
...
GetFriendListsResponse::mutable_friendlist() {
  // @@protoc_insertion_point(field_mutable_list:test.GetFriendListsResponse.friendList)
  return &friendlist_;
}
inline const ::test::User& GetFriendListsResponse::_internal_friendlist(int index) const {
  return friendlist_.Get(index);
}
inline const ::test::User& GetFriendListsResponse::friendlist(int index) const {
  // @@protoc_insertion_point(field_get:test.GetFriendListsResponse.friendList)
  return _internal_friendlist(index);
}
inline ::test::User* GetFriendListsResponse::_internal_add_friendlist() {
  return friendlist_.Add();
}
inline ::test::User* GetFriendListsResponse::add_friendlist() {
  // @@protoc_insertion_point(field_add:test.GetFriendListsResponse.friendList)
...
GetFriendListsResponse::friendlist() const {
  // @@protoc_insertion_point(field_list:test.GetFriendListsResponse.friendList)
  return friendlist_;
}
